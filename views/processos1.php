...
<div class="modal-body">
  <form id="formNovoProcesso" enctype="multipart/form-data">
    ...
    <ul class="nav nav-tabs" id="tabsNovoProcesso" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="tab-eventos-tab" data-bs-toggle="tab" data-bs-target="#tab-eventos" type="button" role="tab">
          <i class="bi bi-calendar-check"></i> Prazos/Eventos
        </button>
      </li>
    </ul>
      ...
      <div class="tab-pane fade" id="tab-fin" role="tabpanel" aria-labelledby="tab-fin-tab">
        ...
        <div class="alert alert-light border d-flex align-items-center gap-2">
          ...
          <div class="small text-muted m-0">
            Esta aba prepara os campos. Depois a gente valida e salva no banco.
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            ...
            <div class="input-group">
              <span class="input-group-text">R$</span>
              <input type="text" class="form-control" name="fin_valor_total" placeholder="0,00">
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <div class="form-text">Se vazio, você define depois.</div>
          </div>
        </div>
        ...
        <div class="row mb-3" id="finBlocoEntrada" style="display:none;">
          <div class="col-md-4">
            ...
            <div class="input-group">
              <span class="input-group-text">R$</span>
              <input type="text" class="form-control" name="fin_valor_entrada" placeholder="0,00">
            </div>
          </div>
          <div class="col-md-8">
            <div class="form-text mt-2">
              Use “Com entrada” quando parte é paga agora e o restante depois (1 ou mais parcelas).
            </div>
          </div>
        </div>
        ...
        <div class="row mb-3" id="finBlocoParcelas" style="display:none;">
          <div class="col-md-4">
            ...
            <div class="form-text">Escolha de 1 a 10 parcelas.</div>
          </div>
...
<script>
  ...
  if (!tipo || !blocoEntrada || !blocoParcelas) return;
  ...
  function apply(){
    ...
    if (v === 'entrada') {
      ...
      blocoParcelas.style.display = ''; // entrada normalmente implica parcelas também (pode ser 1x)
      return;
    }
    if (v === 'parcelado') {
...
// Ativar ao abrir o modal (você já tem esse listener)
document.addEventListener('DOMContentLoaded', function(){
  ...
  if (novoProcModal) {
    novoProcModal.addEventListener('show.bs.modal', function(){
      // deixa o financeiro pronto
      setTimeout(initFinanceiroNovoProcesso, 0);
    });
  }
});
